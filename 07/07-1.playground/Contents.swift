...
let allPossibles = recursiveContainers(for: containers(for: myColor))
let set = allPossibles
    .reduce(into: Set<Bag>()) { accu, new in accu.insert(new) }
